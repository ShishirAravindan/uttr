...
On first launch, uttr downloads the Parakeet model (~600 MB) — the menu bar icon shows a loading state (`…`) until it's ready, and recording is held until then. After that it's cached and starts instantly.
